...
<nav className="navbar navbar-expand-lg bg-light">
  <div className="container-fluid ">
    <a className="navbar-brand" href="#" id='titulo'>Zebra</a>
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><a className="dropdown-item" href="#">Lenceria</a></li>
            <li><a className="dropdown-item" href="#">Corseteria</a></li>
            <li><a className="dropdown-item" href="#">Bikinis</a></li>
            <li><a className="dropdown-item" href="#">Accesorios</a></li>
          </ul>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="#">A Medida</a>
        </li>
      </ul>
